...
If you meet problem similar to `No such file or directory: '/tmp/gradio/tmpgshj4x4l.png'`, it is due to the webui version problem. Please revert to webui v1.3.1 via `git checkout v1.3.1` on your terminal.
